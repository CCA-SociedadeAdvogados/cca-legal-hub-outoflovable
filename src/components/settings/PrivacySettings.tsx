        ...
        <CardContent>
          <div className="rounded-lg bg-muted/50 p-4 space-y-2">
            <p className="text-sm text-muted-foreground">
              {t(
                'privacy.gdprInfo',
                'De acordo com o Regulamento Geral sobre a Proteção de Dados (RGPD), tem direito a:',
              )}
            </p>
            <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1">
              ...
              <li>
                {t('privacy.rights.erasure', 'Solicitar a eliminação dos seus dados (Artigo 17)')}
              </li>
        ...
        <CardHeader>
          ...
          <CardDescription>
            {t(
              ...
              'Descarregue uma cópia de todos os seus dados pessoais em formato JSON.',
            )}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="rounded-lg bg-muted/50 p-4">
            <p className="text-sm text-muted-foreground">
              {t(
                'privacy.export.info',
                'O ficheiro incluirá: perfil, membros de organizações, histórico de atividade, notificações, e contratos criados.',
              )}
            </p>
          </div>
          <Button
        ...
        <CardHeader>
          ...
          <CardDescription>
            {t(
              ...
              'Solicitar a eliminação permanente da sua conta e dados.',
            )}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {hasPendingDeletion && pendingDeletionRequest ? (
            <div className="rounded-lg border border-warn/30 bg-warn/10 p-4 space-y-3">
              ...
              <p className="text-sm text-warn">
                ...
                <strong>
                  {pendingDeletionRequest.scheduled_execution_at
                    ? format(new Date(pendingDeletionRequest.scheduled_execution_at), 'PPP', {
                        locale: pt,
                      })
                    : 'N/A'}
                </strong>
              ...
              >
                {cancelDeletionRequest.isPending && (
            ...
            <>
              <div className="rounded-lg bg-destructive/10 p-4 space-y-2">
                ...
                <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1">
                  <li>
                    {t(
                      'privacy.deletion.warningItem1',
                      'Todos os seus dados pessoais serão eliminados ou anonimizados',
                    )}
                  </li>
                  <li>
                    {t('privacy.deletion.warningItem2', 'Perderá acesso a todas as organizações')}
                  </li>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="space-y-4">
                      <p>
                        {t(
                          'privacy.deletion.confirmDesc',
                          'Para confirmar, introduza a sua palavra-passe. A eliminação será agendada para daqui a 7 dias.',
                        )}
                      </p>
        ...
        <CardHeader>
          ...
          <CardDescription>
            {t(
              ...
              'Registo dos seus pedidos de acesso e eliminação de dados.',
            )}
          </CardDescription>
        </CardHeader>
        <CardContent>
